...
public record CrearPedidoRequestDTO(
    ...
    public record Item(
            ...
            /** Precio de lista unitario CON IVA (BRUTO, sin el descuento de la
             *  línea). Es la base sobre la que el backend aplica el recargo/
             *  descuento de la forma de pago elegida. Para pedidos de presupuesto
